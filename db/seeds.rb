...
user1 = User.create :email => 'jaydeemin@gmail.com', :password => 'elmermin169'
volApp1 = Volunteer.create :first_name => 'Elmer', :last_name => 'Min', :gender => 'Male', :birthday => 'May 18 1990', :city => 'Berkeley', :state => 'CA', :street_address => '2418 Dwight Way', :phone => '805-535-5159'
user1.apps << volApp1
